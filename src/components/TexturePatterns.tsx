...
interface TexturePatternsProps {
  photos?: Photos[];
...
const TexturePatterns = (props: TexturePatternsProps): JSX.Element => {
  ...
  //const [images, search] = useImages('');
  const photoEndpoint = '/topics/textures-patterns/photos';
    ...
    <div className="container-fluid">
      <div className="d-flex flex-row detail-section">
        <div className="col detail-section-left">
          <h1 className="detail-header">Textures & Patterns</h1>
        ...
        <div className="col detail-section-right">
          <div className="row justify-content-center stats-section">
            ...
            <button type="button" className="btn btn-dark stats-btn">
              Submit to <strong>Texture & Patterns</strong>
            </button>
          </div>
        </div>
      </div>
