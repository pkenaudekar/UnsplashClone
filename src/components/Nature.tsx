...
const Nature = (props: NatureProps): JSX.Element => {
  ...
  const photoEndpoint = '/topics/nature/photos';
    ...
    <div className="container-fluid">
      <div className="d-flex flex-row detail-section">
        <div className="col detail-section-left">
          <h1 className="detail-header">Nature</h1>
          <h2 className="detail-content">
            Let’s celebrate the magic of Mother Earth — with images of
            everything our planet has to offer, from stunning seascapes, starry
