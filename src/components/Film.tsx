...
const Film = (props: FilmProps): JSX.Element => {
  ...
  const photoEndpoint = '/topics/film/photos';
    ...
    <div className="container-fluid">
      <div className="d-flex flex-row detail-section">
        <div className="col detail-section-left">
          <h1 className="detail-header">Film</h1>
          <h2 className="detail-content">
            Beautiful analog photography from the past and present day —
            featuring polaroids, black and white images, grainy portraits, and
            more.
          </h2>
        </div>
