...
const HealthWellness = (props: HealthWellnessProps): JSX.Element => {
  ...
  const photoEndpoint = '/topics/health/photos';
  ...
  useEffect(() => {
    //console.log('photosH&W ' + JSON.stringify(photos));
    //.log('searchPhotosH&W ' + JSON.stringify(searchPhotos));
    ...
    <div className="container-fluid">
      <div className="d-flex flex-row detail-section">
        <div className="col detail-section-left">
          <h1 className="detail-header">Health & Wellness</h1>
          <h2 className="detail-content">
            Celebrate a healthy mind, body and soul with photographs that
            showcase everything from new medical discoveries and alternative
        ...
        <div className="col detail-section-right">
          <div className="row justify-content-center stats-section">
                  ...
                  <div className="d-flex flex-row justify-content-between">
                    <div>
                      <svg
                        ...
                        fill="currentColor"
                        className="bi bi-lightning-charge stats-icons"
                        viewBox="0 0 16 16"
                      >
                  ...
                  <div className="d-flex flex-row justify-content-between">
                    <div>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="currentColor"
                        className="bi bi-person stats-icons"
                        viewBox="0 0 16 16"
                      >
                    ...
                    <div>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="currentColor"
                        className="bi bi-emoji-sunglasses stats-icons"
                        viewBox="0 0 16 16"
                      >
                  ...
                  <div className="d-flex flex-row justify-content-between">
                    <div>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="currentColor"
                        className="bi bi-image stats-icons"
                        viewBox="0 0 16 16"
                      >
                  ...
                  <div className="d-flex flex-row justify-content-between">
                    <div>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="currentColor"
                        className="bi bi-people stats-icons"
                        viewBox="0 0 16 16"
                      >
                    ...
                    <div>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="currentColor"
                        className="bi bi-emoji-sunglasses-fill stats-icons"
                        viewBox="0 0 16 16"
                      >
                      ...
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="currentColor"
                        className="bi bi-emoji-wink-fill stats-icons"
                        viewBox="0 0 16 16"
                      >
            ...
            <button type="button" className="btn btn-dark stats-btn">
              Submit to <strong>Health & Wellness</strong>
            </button>
          </div>
        </div>
      </div>
