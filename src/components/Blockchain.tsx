...
const Blockchain = (props: BlockchainProps): JSX.Element => {
    ...
    <div className="container-fluid">
      <div className="d-flex flex-row detail-section">
        <div className="col detail-section-left">
          <h1 className="detail-header">Blockchain</h1>
        ...
        <div className="col detail-section-right">
          <div className="row justify-content-center stats-section">
            ...
            <button type="button" className="btn btn-dark stats-btn">
              Submit to <strong>Blockchain</strong>
            </button>
            <div className="last-date">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="currentColor"
                className="bi bi-clock stats-icons"
                viewBox="0 0 16 16"
              >
                <path d="M8 3.5a.5.5 0 0 0-1 0V9a.5.5 0 0 0 .252.434l3.5 2a.5.5 0 0 0 .496-.868L8 8.71V3.5z"></path>
                <path d="M8 16A8 8 0 1 0 8 0a8 8 0 0 0 0 16zm7-8A7 7 0 1 1 1 8a7 7 0 0 1 14 0z"></path>
              </svg>
              &nbsp;&nbsp;Open to contributions until February 9, 2022 at 5:29
              AM.
            </div>
          </div>
        </div>
